<!-- 
	*易用的头像裁剪上传、头像美化组件
	*用于图片裁剪、图片美化、小程序、App(ios android)、H5 全平台支持
	*文档：https://ext.dcloud.net.cn/plugin?id=404 
	*演示网址：http://www.snyvic.eu/#/
-->
	...
	export default {
		...
		methods: {
			fWindowResize() {
				...
				this.csH = (this.wH - tH - this.systemInfo.safeAreaBottom) + 'px';
				// #endif
...
<style>
	...
	.oper-wrapper {
		...
		border-bottom: var(--safe-area-inset-bottom) solid #FFFFFF;
		background: #ffffff;
		width: 100%;
		left: 0;
		bottom: 0;
