<!--
    * Desc    : 这个由u-tabs-swiper复制过来改动的
    * 修改    ：2021-11-03，修改内容：1、watch里的current加入setTimeout 500毫秒，不加setTimeout的话，当tab大于三个时，会出现点击中间的tab，下划线会先滚动到最边上再瞬间闪到中间的bug
-->
<template>
	<view
		class="u-tabs"
...
export default {
	...
	computed: {
		...
		// 滑块需要移动的距离
		scrollBarLeft() {
			// console.log(this.line3Dx, this.line3AddDx, 7788);
			return Number(this.line3Dx) + Number(this.line3AddDx);
			// return Number(this.line3Dx);
		},
		// 滑块的宽度转为px单位
		barWidthPx() {
